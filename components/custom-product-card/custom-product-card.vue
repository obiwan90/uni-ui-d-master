<template>
	<view class="container" style="margin-top: 20rpx;" @click.stop="goDetailPage(props.good)">
	...
	<view v-if="false" class="settings">
		<view class="settings-box">
			...
			<view class="settings-r">
				...
				<view class="settings-r-r"  @click.stop="openEditPrice">
