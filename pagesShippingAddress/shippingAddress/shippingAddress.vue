<template>
	<view class="shoppingAddress-layout page">
		<!-- header -->
		<custom-header>
			<template #name>发货地址</template>
			<template #fill>发货地址</template>
		</custom-header>
		...
		<view class="card" v-for="(item,index) in addressList" :key="item.id" >
			<view class="top">
				...
				<view class="right">
					<image src="https://www.xzxskj.com/xcximg/icon_bianji@3x.png" mode="aspectFill" @click="goPage('/pagesShippingAddress/shippingAddress/new?id='+item.id)"></image>
