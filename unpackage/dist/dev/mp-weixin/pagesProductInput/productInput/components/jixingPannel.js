...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getPagingData = async (param2) => {
      ...
      const res = await pagesProductInput_api_api.apiRecycleClassify(data);
      if (res.code === "200") {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        i: common_vendor.sr(paging, "dcfba5d4-2", {
          "k": "paging"
        }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-dcfba5d4"]]);
