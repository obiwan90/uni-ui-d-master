...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getPagingData = async (param2) => {
      ...
      const res = await pagesNewSell_api_api.apiGetClasstify(data);
      if (res.code === "200") {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: common_vendor.f(brandlist.value, (item, index, i0) => {
          return {
        ...
        h: common_vendor.f(transformedData.value, (item, index, i0) => {
          return {
            a: common_vendor.t(item.name),
            b: common_vendor.f(item.products, (item1, index1, i1) => {
              return {
                a: common_vendor.t(item1.qcname),
                b: index1,
        ...
        i: common_vendor.sr(paging, "94df34ba-2", {
          "k": "paging"
        }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-94df34ba"]]);
