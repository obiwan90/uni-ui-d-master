  ...
  setup(__props, { emit: __emit }) {
    ...
    const getAddressList = async () => {
      if (selectedAddress.value) {
        ...
        const res = await pagesCustomServiceOrderDetail_api_api.apigetAddress(data);
    ...
    const apiBookingExpressAc = async () => {
      ...
      try {
        const res = await pagesCustomServiceOrderDetail_api_api.apiBookingExpress(param);
        if (res.code === 200) {
          common_vendor.index.showToast({
            title: "操作成功",
            icon: "success",
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        k: common_vendor.sr("datePicker", "2459ff89-0"),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-2459ff89"]]);
